...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.buildkit-machine.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".buildkit-machine" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".buildkit-machine")
	}
